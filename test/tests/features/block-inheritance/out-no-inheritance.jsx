...
const BlockNoInheritance = () => {
  ...
  return <div className="Block">
            ...
            <div className="Block0 Block1 Block2">
                ...
                <div className={`Block0-Elem0 Block0-Elem1 Block0-Elem2 Block1-Elem0 Block1-Elem1 Block1-Elem2 Block2-Elem0 Block2-Elem1 Block2-Elem2${isTrue ? " Block0-Elem0_mods0 Block0-Elem1_mods0 Block0-Elem2_mods0 Block1-Elem0_mods0 Block1-Elem1_mods0 Block1-Elem2_mods0 Block2-Elem0_mods0 Block2-Elem1_mods0 Block2-Elem2_mods0" : ""}${isTrue ? " Block0-Elem0_isTrue Block0-Elem1_isTrue Block0-Elem2_isTrue Block1-Elem0_isTrue Block1-Elem1_isTrue Block1-Elem2_isTrue Block2-Elem0_isTrue Block2-Elem1_isTrue Block2-Elem2_isTrue" : ""}`} />
