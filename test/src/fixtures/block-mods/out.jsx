const BlockElem = () => {
  ...
  return <>
            ...
            <div className="Block Block_mods0 Block_mods1 mods0 mods1" />
            <div className="Block Block_mods0 Block_mods1 mods0" />
            <div className="Block Block_mods0 Block_mods1" />
            <div className={`Block ${isTrue ? "Block_isTrue" : ""}${isTrue ? "Block_isTrue" : ""}`} />
            <div className={`Block ${isFalse ? "Block_isFalse" : ""}${isFalse ? "Block_isFalse" : ""}`} />
            <div className={`Block ${true === true ? "Block_trueExpression" : ""}${true === false ? "Block_falseExpression" : ""}`} />
            ...
            <div className="Block0 Block1 Block2 Block0_mods0 Block0_mods1 Block1_mods0 Block1_mods1 Block2_mods0 Block2_mods1 mods0 mods1" />
            <div className="Block0 Block1 Block2 Block0_mods0 Block0_mods1 Block1_mods0 Block1_mods1 Block2_mods0 Block2_mods1 mods0" />
